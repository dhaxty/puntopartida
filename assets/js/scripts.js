...
if (btnMenuToggle && navLinks.length > 0) {
...
// Este bloque completo solo se ejecuta si el modal existe en la página actual
if (modalOverlay && modalCerrarBtn) {
    ...
    if (botonesVerDetalle.length > 0) {
        botonesVerDetalle.forEach(function (btn) {
